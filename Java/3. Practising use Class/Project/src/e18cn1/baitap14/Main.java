package e18cn1.baitap14;

import e18cn1.baitap12.Matrix;
...
public class Main {
    ...
    public static void main( String[] args ) {
        ...
        nd2.hien();
        if ( s[0].lonHon(s[1]) )
            System.out.println("Số phức thứ nhất lớn hơn!");
        else if ( s[0].nhoHon(s[1]) )
            System.out.println("Số phức thứ hai lớn hơn!");
        else
